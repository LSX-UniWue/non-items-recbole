...
class LightSANsAttr(LightSANs):
    ...
    def forward(self, interaction):
        ...
        item_emb = concat_user_embeddings(self.user_attributes,embedded_user_features, item_seq_emb)
        ...
        position_ids = torch.arange(max_seq_len, dtype=torch.long, device=item_seq.device)
